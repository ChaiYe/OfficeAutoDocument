...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="${pageContext.request.contextPath}/index.jsp">我的桌面</a>
								<i class="icon-angle-right"></i> <a href="${pageContext.request.contextPath}/pages_hr/findDeptAll.action">部门管理</a> <i
								class="icon-angle-right"></i>修改部门</li>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form
									action="${pageContext.request.contextPath}/pages_hr/updateDept.action"
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="deptNumber" class="m-wrap span12"
														placeholder="必需以字母D开头" value="${dept.deptNumber }" />
												</div>
											</div>
										</div>
									</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="deptName" class="m-wrap span12"
														placeholder="必填" value="${dept.deptName }" />
												</div>
											</div>
										</div>
									</div>
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="deptDescripti" class="m-wrap span12"
														placeholder="选填" value="${dept.deptDescripti }" />
												</div>
											</div>
										</div>
									</div>
	...
	<script src="${pageContext.request.contextPath}/main_pages/crm_table_editable.js"></script>
	<script src="${pageContext.request.contextPath}/main_pages/selectparam.js"></script>
	<script>
