				...
				<div class="container-fluid">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<!-- BEGIN 网页的标题和面包屑-->
							<h3 class="page-title">
								<strong> 请假管理<small>修改请假记录</small> </strong>
							</h3>
							<ul class="breadcrumb">
								<li>
									<strong> <a href="${pageContext.request.contextPath}/index.jsp">我的桌面</a> <a
										href="${pageContext.request.contextPath}/hrm/findAllLeaves.action">请假管理</a> 修改请假记录</strong>
								</li>
							</ul>
							<!-- END 网页的标题和面包屑-->
						</div>
						...
						<div class="span12">
							...
							<div class="portlet box blue">
								...
								<div class="portlet-body form">
									<!-- BEGIN FORM-->
									<form id="frm" action="${pageContext.request.contextPath}/hrm/updateLeave.action" method="post"  class="form-horizontal">
										<h3 class="form-section">
											<strong>请假信息</strong>
										</h3>
										<input type="hidden" name="leaId" value="${leave.leaId }">
										<div class="row-fluid">
											<div class="span6">
												<div class="control-group">
													...
													<div class="controls">
														<div class="input-append date date-picker"
															...
															<strong><input type="text" name="leaDate" value='<f:formatDate value="${leave.leaDate}" pattern="yyyy-MM-dd"/>'
										...
										<div class="row-fluid">
											<div class="span6 ">
												<div class="control-group">
													...
													<div class="controls">
														<strong><input type="text" name="leaTime" value="${leave.leaTime }"
										...
										<div class="row-fluid">
											<div class="span6 ">
												<div class="control-group">
													...
													<div class="controls">
														<strong><input type="text" name="leaCause" value="${leave.leaCause }"
																 class="m-wrap span12" placeholder="必填">
														</strong>
													</div>
												</div>
													...
													<div class="controls">
														<strong>
														    <select 
																...
																<option value="${leave.emp.empId}">${leave.emp.empName}</option>
