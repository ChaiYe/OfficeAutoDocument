    ...
    a.fn.tagsInput = function(d) {
        ...
        this.each(function() {
            ...
            if (e.interactive) {
                ...
                a(f.holder).bind("click", f,
                function(b) {
                    a(b.data.fake_input).focus()
                });
                a(f.fake_input).bind("focus", f,
                function(b) {
                ...
                if (e.autocomplete_url != undefined) {
                    ...
                    if (jQuery.Autocompleter !== undefined) {
                        ...
                        a(f.fake_input).bind("autocompleteselect", f,
                        function(b, c) {
                ...
                a(f.fake_input).bind("keypress", f,
                function(b) {
                ...
                f.removeWithBackspace && a(f.fake_input).bind("keydown",
                function(b) {
