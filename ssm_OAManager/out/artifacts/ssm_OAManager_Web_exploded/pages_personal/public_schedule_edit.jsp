					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>编辑日程
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form
									action="${pageContext.request.contextPath}/sys_schedule/updateSchedule.action"
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="hidden" name="scheduleId"
														value="${data.scheduleId}" /> <input
														name=scheduleDesprict type="text" class="m-wrap span10"
														placeholder="必填" value="${data.scheduleDesprict}">
												</div>
											</div>
										</div>
										<!--/span-->
													...
													<div class="control-group">
														...
														<div class="controls">
															<div class="input-append date date-picker"
																...
																<input placeholder="请选择" name="scheduleDate"
																	class="m-wrap m-ctrl-medium date-picker" size="16"
																	type="text"
																	value="<fmt:formatDate value='${data.scheduleDate}'
