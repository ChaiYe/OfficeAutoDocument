					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a
								...
								href="${pageContext.request.contextPath}/pages_public/public_notice_list.jsp">公告列表</a>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form
									action="${pageContext.request.contextPath}/view/announcement/insertAnnouncement.action"
									...
									<div class="row-fluid">
										<div class="span12 ">
											<div class="control-group">
												...
												<div class="controls">
													<textarea rows="5" class="m-wrap span10" placeholder="必填"
														name="amConten"></textarea>
												</div>
											</div>
										</div>
									</div>
													...
													<div class="control-group">
														...
														<div class="controls">
															<div class="input-append date date-picker"
																...
																<input name="amDate" placeholder="请选择"
