					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="${pageContext.request.contextPath}/index.jsp">我的桌面</a>
								<i class="icon-angle-right"></i> <a href="${pageContext.request.contextPath}/hrm/findAllEvections.action">出差管理列表</a>
								<i class="icon-angle-right"></i> 出差列表</li>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								...
								<div class="actions">
									<button id="sample_editable_1_new"
										onclick="location.href='${pageContext.request.contextPath}/hrm/findEmpToEve.action'"
										class="btn red">
							...
							<div class="portlet-body">
								<table
									...
									<tbody>
										<c:forEach items="${evections}" var="eve">
											<tr>
												<td>${eve.evId }</td>
												<td><f:formatDate value="${eve.date}"
														pattern="yyyy-MM-dd" /></td>
												<td>${eve.time }</td>
												<td>${eve.cause }</td>
												<td>${eve.cost }</td>
												<td>${eve.emp.empName}</td>
												<td>
													<!-- begin操作按钮 -->
													<div class="btn-group"
														...
														<ul class="dropdown-menu">
															...
															<li><a data-toggle="modal"
																href="${pageContext.request.contextPath}/hrm/findEvectionById.action?eveId=${eve.evId}">
																	<i class="icon-edit"></i>编辑</a></li>
															<li><a href="#" title="${eve.evId}" class="user_del"><i
		...
		$(".user_del")
				.click(
						function() {
							...
							//在tr下查找第一个td
							//获取td的文本内容
							var adminName = $tr.children("td:eq(5)").text();
							...
							swal(
									...
									function() {
										window.location.href = "${pageContext.request.contextPath}/hrm/deleteEvection.action?eveId="
												+ cId;
									});
