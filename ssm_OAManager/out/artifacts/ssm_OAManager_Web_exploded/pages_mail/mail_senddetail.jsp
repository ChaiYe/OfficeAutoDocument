		...
		<div class="page-content">
			<div class="container-fluid"> 
		     ...
		     <!--  -->
                    ...
                    <div class="portlet-title"><div class="caption">
                    <i class="icon-time"></i>发送时间：${mail.time} &nbsp;&nbsp;&nbsp;&nbsp;收件人：${mail.reveicer}
                    </div>
                    </div>
                    <!-- 添加标签 -->
                    <c:if test="${mail.sereveicer!=''|| mail.anreveicer!=''}">
                    <div class="portlet-title"><div class="caption">
                    <c:if test="${mail.sereveicer!=''}">
                    <i class="icon-user"></i>抄送人：${mail.sereveicer}</c:if>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <c:if test="${mail.anreveicer!=''}">
                     暗送人：${mail.anreveicer}
                     </c:if>
                    </div>
                    </div>
                    ...
                    <c:if test="${mail.attachment!=null && mail.attachment!=''}">
                    <strong>提醒！</strong> 如下附件已发！
                    </c:if>
                    </div> 
                    <c:if test="${mail.attachment!=null && mail.attachment!=''}">
                    <font style="font-weight: bolder; font-size:15px; color:#4D82A3;">附件内容</font><br>
                    <a class="btn mini green" href="#" ><i class="icon-file"></i>&nbsp;${mail.attachment}</a>
                    </c:if>
			         </div></div>
					<!-- END 邮件详情 -->
